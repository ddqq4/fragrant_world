...
--
-- Хост: localhost
-- Время создания: Дек 26 2025 г., 23:45
...
(16, 3, 2, 1, '2025-12-26 22:42:37'),
(17, 3, 4, 1, '2025-12-26 22:42:39'),
(18, 3, 1, 1, '2025-12-26 22:42:41');
...
(1, 3, 'вчачспмро', '2025-12-26 20:37:24');
...
INSERT INTO `orders` (`id`, `user_id`, `order_number`, `customer_name`, `email`, `address`, `phone`, `comment`, `payment_method`, `status`, `subtotal`, `delivery_cost`, `total_amount`, `created_at`, `updated_at`) VALUES
(1, 3, 'O000001', 'qwe', 'qwe@gmail.com', 'еапро', '+71234567893', '', 'cash', 'pending', 1200.00, 300.00, 1500.00, '2025-12-26 20:42:38', '2025-12-26 20:42:38');
...
CREATE TRIGGER `before_order_insert` BEFORE INSERT ON `orders` FOR EACH ROW BEGIN
    ...
    SELECT IFNULL(MAX(CAST(SUBSTRING(order_number, 2) AS UNSIGNED)), 0) + 1 
    INTO next_num 
    FROM orders;
...
(1, 1, 1, 'Арабика Бразилия', 500.00, 1),
(2, 1, 2, 'Робуста Вьетнам', 400.00, 1),
(3, 1, 3, 'Зеленый чай', 300.00, 1);
